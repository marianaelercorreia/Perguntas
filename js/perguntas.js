export const perguntas = [
    {
        ...
        alternativas: [
            ...
            {
                texto: "Você resolve fugir da Coreia do Norte, mesmo sendo uma missão suicida.",
                afirmacao: [
    ...
    {
        enunciado: "Então você opta por fugir, agora precisa entender alguns métodos eficazes. Muitos já tentaram descobrir isso e fracassaram... Qual será o métodos que você usará?",
        alternativas: [
            {
                texto: "Usar a internet ilegalmente em uma área pública para pesquisa.",
                afirmacao: [
